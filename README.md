# Awesome Sapphire [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- [Sapphire Plugin Modal Commands](https://github.com/MajesticString/sapphire-plugin-modal-commands#readme): Plugin for [`@sapphire/framework`](https://github.com/sapphiredev/framework) that allows modal submits to be handled in the corresponding command.
